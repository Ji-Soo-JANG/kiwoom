...
public class PortfolioController {
    ...
    @GetMapping
    public Flux<PortfolioPosition> findAll(Principal principal) {
    ...
    public Mono<List<PortfolioValuation>> valuate(Principal principal) {
        return service.valuate(principal.getName());
    }
}
